...
<script>
    function flashy(message, link) {
        ...
        ).hide().fadeIn(300).delay(4000).fadeOut(300);
        template.find(".flashy__link").attr("href", link).end()
         .appendTo("body");
...
<script id="flashy-template" type="text/template">
    ...
    <div class="flashy flashy--{{ Session::get('flashy_notification.type') }}">
        <a href="#" class="flashy__link" target="_blank"><label class="flashy__body"></label></a>
    </div>
